...
export class LugaresService {
  ...
  _consultarComunidadesPorVersion(
    ...
    _idCabeceraVersionCuestionarioEncriptado:any,
  ){
    const _body = new HttpParams();

    return new Promise ((resolve,reject)=>{
      this.http.post(url+'comunidad_consultarporversion?_idCuestionarioEncriptado='+_CodigoCuestionarioEncriptado+'&_idCabeceraVersionCuestionarioEncriptado='+_idCabeceraVersionCuestionarioEncriptado, _body.toString(),{headers:this._header})
                .subscribe(res=>{
                  resolve(res);
                },(err)=>{
                  reject(err);
